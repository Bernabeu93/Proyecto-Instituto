...
export const alumnos: AlumnoCrear[] = [
  ...
  { id: 9, dni:'97531068J',nombre: 'Isabel' ,apellidos: 'Torres Ramírez',usuario:'eowyn_escudo de roble', password:'letmein'},
  { id: 10, dni:'71450682S',nombre: 'Ramiro', apellidos: 'Castro Medina',usuario:'gimli_hijo de glóin', password:'monkey'}
];